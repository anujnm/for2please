...
function sales_init()
{
	add_menu_page('Sales Report', 'Sales Report', 'administrator' , 'salereport','sales_report_page','/vancouver/wp-content/themes/images/datesmalle.png',6);
}
...
function type_create_taxonomies() 
{
	...
	$type_labels = array(
		...
		'show_ui' => true,
		'query_var' => true,
		'rewrite' => array('slug' => 'date-idea-type' )
	));
}
...
function location_create_taxonomies() 
{
	...
	$location_labels = array(
		...
		'show_ui' => true,
		'query_var' => true,
		'rewrite' => array('slug' => 'date-idea-location' )
	));
}
...
function time_create_taxonomies() 
{
	...
	$time_labels = array(
		...
		'show_ui' => true,
		'query_var' => true,
		'rewrite' => array('slug' => 'date-idea-time' )
	));
}
...
function price_create_taxonomies() 
{
	...
	$price_labels = array(
		...
		'show_ui' => true,
		'query_var' => true,
		'rewrite' => array('slug' => 'date-idea-price' )
	));
}
