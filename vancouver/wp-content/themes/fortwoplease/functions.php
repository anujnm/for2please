...
<br/><p style="margin:0;">p.s. Have any questions or need some help? Email us at <b>support@fortwoplease.com</b> or call us at <b>604.600.8441</b> and we\'ll get back to you as soon as we can!</p><br/><p style="margin:0;"><a href="http://www.fortwoplease.com/vancouver/myaccount">Take me to my account page</a></p><p style="margin:0;"><a href="http://www.fortwoplease.com/">Discover more date ideas!</a></p>',$headers);
		...
		for ($i = $numberp; $i > 0; $i--) {
			...
			add_user_meta($merchantuname,$unique.'_transID', $transID);
...
function send_confirmation_email(){
	...
	$headers = 'From: ForTwoPlease <info@fortwoplease.com/>' . "\r\n";
	add_filter('wp_mail_content_type',create_function('', 'return "text/html";'));
	wp_mail($user_email, 'Your Next Great Date!', '<strong>Congratulations '.$name.'</strong><p>Your purchase of ['.$bname.'-'.$pname.'] was successful.</p><p><b>TO USE: Phone '.$phone.' to reserve a time for your date.</b> Just say your name and ForTwoPlease ID, which is <b>'.$userID.'</b>, and the business will take care of the rest. (You can call to reserve anytime, however you have to reserve before you can use your date.)</p><p>When you show up, say your name and ForTwoPlease ID -  it’s that easy!</p><p>The details of your Date Package are also in your account, which you can access at anytime: <a href="https://fortwoplease.com/vancouver/myaccount/">Your Account</a>. But please don’t print anything. Dating is a classy affair!</p><BR /><strong>Date Package Payment Summary</strong><p>Total: $'.$totalPrice.'</p><p>Transaction ID:'.$transID.'</p><BR /><p>And, if you want to really WOW your date, we can help you with flowers, babysitters or even hair dos with our <a href="https://fortwoplease.com/vancouver/date-enhancer/">Date Enhancers.</a></p><p>Enjoy!</p><p>-The ForTwoPlease Team</p><p>p.s. As always, if you have any questions shoot us an email and we’ll get back to you within one business day - support@fortwoplease.com</p>',$headers);
...
function new_user_reg(){
	...
	$headers = 'From: ForTwoPlease <info@fortwoplease.com>' . "\r\n";
	add_filter('wp_mail_content_type',create_function('', 'return "text/html";'));
	wp_mail($user_email, 'Your Dates Just Got Better ', '<strong>You are in!</strong><p>We’re excited that you’ve joined our ForTwoPlease community. Now that you’re a member, we can start recommending better dates that we think you’ll enjoy.</p><p><b>It’s easy to get started.</b> Find local date ideas based on what you want to do and we’ll help you with the rest – like cabs, babysitters and even private airplanes!</p><a href="https://fortwoplease.com">Your next great date awaits</a><p>If you have any questions, we’d love to hear from you. Shoot us a line on <a href="https://www.facebook.com/fortwoplease/">Facebook</a>
or email us at support@ForTwoPlease.</p><p>Best of Luck!</p><p>The ForTwoPlease Team</p>',$headers);
