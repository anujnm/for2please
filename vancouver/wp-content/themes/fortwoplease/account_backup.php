...
<div id="header-content" style="background:#FFF;color:black;overflow:hidden;padding:20px;">
	...
	<div style="float:left;width:700px;" id="date-holder">
	 <b>Looking for a Date Package you bought on the previous ForTwoPlease website?</b>

            <p style='margin-top:10px;margin-bottom:20px;'>Check your email, as you should have received a copy of it there. If you can't find it, no problem. Shoot us an email at support@fortwoplease.com and we'll send it to you within one business day.</p>
	...
	$doneMerch = get_user_meta($merchantuname, $values.'_d');
		...
		<div style="margin:none;">Reservation Requried By Phone: <?php echo the_field('phone_number',$pid[0]); ?> </div>
		<div style="margin:none;">Total Amount Paid: $<?php echo (get_field('price',$pid[0]) +  get_field('taxes',$pid[0]) +  get_field('fees',$pid[0])); ?> </div>
