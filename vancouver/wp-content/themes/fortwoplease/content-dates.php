		...
		<div class="header_info">
			...
			<div class="date_info">
				<div class="links">
					...
					<div style="width: 65px;"><a href="http://pinterest.com/pin/create/button/?url=<?php echo current_page_url(); ?>&media=<?php the_field('image_1'); ?>&description=this%20is%20the%20description" class="pin-it-button" count-layout="vertical"><img border="0" src="/vancouver/wp-content/themes/images/pinit.png" title="Pin It" /></a></div>
					<div style="width: 70px; margin-top:3px;"><img src="/vancouver/wp-content/themes/images/email_btn.png" width="60" height="22" style="cursor:pointer;" onclick="jQuery('#share-date').lightbox_me({centered: true,});"/></div>
