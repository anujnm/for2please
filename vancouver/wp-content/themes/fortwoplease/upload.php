  ...
  <div id='header-content' class="header-content" style='color:black;'>
      <div id="left-hand" style="float:left;width:640px;padding:20px 20px 20px 50px;">
        ...
        if (isset($_GET['uploaded']) && $_GET['uploaded'] == 'True') {
          ...
          <p><b>Please fill out the form below by October 3, 2014, to be nominated for the "ForTwoPlease Guide to <?php echo $current_city; ?>'<?php if (substr($current_city, strlen($current_city)-1) != 's') { echo 's';}?> Best Fall Date Spots".</b></p><br/>
          <p>Final selections will be made by October 10, 2014.</p><br/><br/>
        <?php
      } else {
        ...
        ?>
          ...
          <p><b>Please fill out the form below by October 3, 2014, to be nominated for the "ForTwoPlease Summer Date Spot".</b></p><br/>
          <p>Final selections will be made by October 10, 2014.</p><br/><br/>
        <?php
      }
        ?>
