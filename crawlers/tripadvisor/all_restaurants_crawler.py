...
def get_urls_from_listing_page(url):
  ...
  for list_item in list:
    url = list_item.find('div', class_='quality').a['href'].encode('UTF-8')
...
list_page_list = ['http://www.tripadvisor.in/Restaurants-g181716-Richmond_British_Columbia.html',
                  'http://www.tripadvisor.in/Restaurants-g181716-oa30-Richmond_British_Columbia.html',
                  'http://www.tripadvisor.in/Restaurants-g181716-oa60-Richmond_British_Columbia.html',
                  'http://www.tripadvisor.in/Restaurants-g181716-oa90-Richmond_British_Columbia.html',]

fname='Richmond/All Restaurants.csv'
with open(fname, 'wb') as outf:
  outcsv = csv.writer(outf)
